...
var Client = require('./client').Client,
  ...
  HapiServer = require('./hapi-server').HapiServer,
...
function listenHapi(server, pathOrOptions, services, xml) {
  var options = {},
    // path = pathOrOptions,
    uri = null;
  ...
  var wsdl = new WSDL(xml || services, uri, options);
  return new HapiServer(server, pathOrOptions, services, wsdl, options);
}
